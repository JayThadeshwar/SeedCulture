...
class LoginPageFarmer extends StatefulWidget {
  LoginPageFarmer({Key key}) : super(key: key);

  @override
  _LoginPageFarmerState createState() => new _LoginPageFarmerState();
}
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: (val) => val.isEmpty
                                          ...
                                          : (val.length==10) ? 'Enter 10-digit phone number' : null,
                                    ),
                                  ),
                                ),
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      validator: (val) => val.isEmpty
                                          ...
                                          : ((val.length>=6) ? 'Enter valid password of length more than 6' : null),
                                    ),
                                  ),
                                ),
                                Expanded(
                                    ...
                                    child: RaisedButton(
                                        ...
                                        onPressed: () async{
                                          if (_formKey.currentState
                                            ...
                                            bool res = await DatabaseOps.verifyFarmer(loginEmailController.text,loginPasswordController.text);                                       
                                            if(res==true){
                                              Navigator.pushReplacementNamed(
                                                context, dashboardRoute, arguments: 1);  
                                            } else{
                                              callError(context);
                                            } 
